...
exports.getDetails = exports.getColorObj = exports.objectToString = exports.isUpperCase = exports.safeBounds = void 0;
...
var safeBounds = function (e) {
    var _a, _b, _c, _d, _e;
    var target = e;
    var client = (_a = target.parentElement) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect();
    var className = target.className;
    var adjuster = className === 'c-resize ps-rl' ? 15 : 0;
    return {
        offsetLeft: (_b = client === null || client === void 0 ? void 0 : client.x) !== null && _b !== void 0 ? _b : 0 + adjuster,
        offsetTop: (_c = client === null || client === void 0 ? void 0 : client.y) !== null && _c !== void 0 ? _c : 0,
        clientWidth: (_d = client === null || client === void 0 ? void 0 : client.width) !== null && _d !== void 0 ? _d : 0,
        clientHeight: (_e = client === null || client === void 0 ? void 0 : client.height) !== null && _e !== void 0 ? _e : 0,
    };
};
exports.safeBounds = safeBounds;
function getHandleValue(x, target, barSize) {
    var _a = (0, exports.safeBounds)(target), offsetLeft = _a.offsetLeft, clientWidth = _a.clientWidth;
    var pos = x - offsetLeft - barSize / 2;
    var adjuster = clientWidth - 18;
    var bounded = (0, formatters_js_1.formatInputValues)(pos, 0, adjuster);
...
function computePickerPosition(e, target, crossSize) {
    var _a = (0, exports.safeBounds)(target), offsetLeft = _a.offsetLeft, offsetTop = _a.offsetTop, clientWidth = _a.clientWidth, clientHeight = _a.clientHeight;
    var _b = getClientXY(e), clientX = _b.clientX, clientY = _b.clientY;
    var getX = function () {
        var xPos = clientX - offsetLeft - crossSize / 2;
        return (0, formatters_js_1.formatInputValues)(xPos, -8, clientWidth - 8);
    };
    var getY = function () {
        var yPos = clientY - offsetTop - crossSize / 2;
        return (0, formatters_js_1.formatInputValues)(yPos, -8, clientHeight - 8);
    };
    return [getX(), getY()];
}
...
var getColorObj = function (colors, defaultGradient) {
    ...
    var upperObj = idxCols === null || idxCols === void 0 ? void 0 : idxCols.find(function (c) { return (0, exports.isUpperCase)(c.value); });
...
var getDetails = function (value) {
    ...
    return { degrees: degrees, degreeStr: degreeStr, isGradient: isGradient, gradientType: gradientType };
};

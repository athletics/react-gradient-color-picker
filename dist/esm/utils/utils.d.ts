...
export declare function getHandleValue(x: number, target: any, barSize: number): number;
export declare function computeSquareXY(s: number, v: number, squareWidth: number, squareHeight: number, crossSize: number): number[];
export declare function computePickerPosition(e: MouseEvent | TouchEvent, target: any, crossSize: number): number[];

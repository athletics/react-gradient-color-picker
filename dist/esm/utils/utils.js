...
export function getHandleValue(x, target, barSize) {
    var _a = safeBounds(target), offsetLeft = _a.offsetLeft, clientWidth = _a.clientWidth;
...
export function computePickerPosition(e, target, crossSize) {
    var _a = safeBounds(target), offsetLeft = _a.offsetLeft, offsetTop = _a.offsetTop, clientWidth = _a.clientWidth, clientHeight = _a.clientHeight;

...
var Opacity = function () {
    ...
    return (React.createElement("div", { onMouseDown: handleDown, style: {
            height: 14,
            marginTop: 17,
            marginBottom: 4,
            cursor: 'ew-resize',
        ...
        React.createElement("div", { ref: opacityRef, style: __assign(__assign({}, defaultStyles.rbgcpOpacityOverlay), { background: bg }), id: "rbgcp-opacity-overlay".concat(pickerIdSuffix), 
